...
/**
 * This extension exports enums that implement an interface as a class with static fields that represent each enum
 * value. This allows the enums to be used to represent an instance of an interface in typescript just like in Java.
 * <p>
